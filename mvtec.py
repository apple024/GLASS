...
class MVTecDataset(torch.utils.data.Dataset):
    ...
    def generate_target_foreground_mask(self, img):
        ...
        # h, w = target_foreground_mask.shape
        # center = target_foreground_mask[h//2, w//2]
        target_foreground_mask = cv2.bitwise_not(target_foreground_mask) # if center == 0 else target_foreground_mask
